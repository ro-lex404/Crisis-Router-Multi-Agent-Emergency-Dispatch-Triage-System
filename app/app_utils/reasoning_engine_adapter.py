...
def attach_reasoning_engine_routes(app: FastAPI) -> None:
    ...
    def get_runtime() -> AdkApp:
        ...
        if runtime is None:
            ...
            print("REASONING ENGINE OPERATIONS:", operations)
            ...
            print("REASONING ENGINE SYNC METHODS:", sync_methods)
            print("REASONING ENGINE STREAMING METHODS:", streaming_methods)
        return runtime
